...
Eine mechanische Verformung wird durch Fortsätze an spezialisierten Zellen erfasst und führt (direkt oder indirekt) zu einer Öffnung oder Schließung von Ionenkanälen.0  \\
...
Eintreffen von Engergie (z.B. Photon, Wärme) an der Außenseite eines Transmembran-Rezeptors bewirkt eine Änderung der Konformation und setzt dadurch Signalkaskaden im Inneren der Zelle in Gang, die zu einer Änderung des Membranpotentials führen. \\
...
% Beispiel: Chemische Sinne: Ähnlichkeitsbereich
...
% \begin{columns}[c]
% \begin{column}{5cm}
% Die Kenntnis der relative Empfindlichkeit von Sinnessystemen spielt in der klinischen Diagnostik eine gro0e Rolle. 

% Welche der folgenden Abbildungen zeigt in diesem Zusammenhang am besten die Beziehung zwischen notwendigem Reizzuwachs (\( \Delta \phi \)) und Größe des Ausgangsreizes (\(\phi\)) für eine erfolgreiche Reizdiskriminiation? 
