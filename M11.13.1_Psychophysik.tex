...
% %%    columns - texz explaining frequency coding, action potential
% % long-term to-do: Mechanistic explanaton of frequency coding like in HMU lecture
...
\item
Aktionspotential. Action_potential.svg: Original by en:User:Chris 73, updated by en:User:Diberri, converted to SVG by tiZomderivative work: de:Benutzer:Jnns, CC BY-SA 3.0 \url{http://creativecommons.org/licenses/by-sa/3.0/}, via Wikimedia Commons
